// Command task043-inimerge runs the INI merge & conflict-detection service.
//
...
import (
	...
	"task043-inimerge/internal/selfcheck"
)
...
func main() {
	...
	fs := flag.NewFlagSet("inimerge", flag.ContinueOnError)
	...
	log.Printf("task043-inimerge listening on %s", *addr)
